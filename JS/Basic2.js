...
if(Math.abs(currentLeftB) == 0){currentLeftB -= 290;}else if(Math.abs(currentLeftB) == 590){currentLeftB -= 320;}else{currentLeftB -= 300;} // negative to move content to the left
