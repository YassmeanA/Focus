...
show.style.clipPath=`circle(${Y}px at calc(50vw - 100px + 74px - ${Z}px) calc(${H}px - ${X}px + 102.2px))`;

}else{

show.style.clipPath=`circle(8.5px at calc(50vw - 100px + 74px - ${Z}px) calc(${H}px - ${X}px + 102.2px))`;
