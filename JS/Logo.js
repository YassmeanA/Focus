...
show.style.clipPath=`circle(8.5px at calc(50vw - 100px + 66.5px - ${Z}px) calc(var(--i) + 103.04px))`;
...
show.style.clipPath=`circle(${Y}px at calc(50vw - 100px + 66.5px - ${Z}px) calc(var(--i) - ${X}px + 103.04px))`;

}else{

show.style.clipPath=`circle(8.5px at calc(50vw - 100px + 66.5px - ${Z}px) calc(var(--i) - ${X}px + 103.04px))`;
